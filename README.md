...
Most of what I build works with the network off. No accounts, no telemetry, no
paywall. Things that keep working on a train, in a basement, or on a phone with
...
decision rules such as Wells, Alvarado, Ottawa and SNNOOP10. Red flags are hard
...
**[Hallal Scanner](https://github.com/YatoVoid/hallal-scanner)** &nbsp;·&nbsp; React Native
